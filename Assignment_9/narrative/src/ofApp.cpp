...
//scene changes
    ...
    scene2 = sec >5 && sec < 8;
    scene3 = sec >= 8 && sec < 11;
    scene4 = sec >= 11 && sec < 14;
    scene5 = sec >= 14 && sec < 27;
    scene6 = sec >= 27 && sec < 52;
    scene7 = sec >= 52 && sec < 55;
    scene8 = sec >= 55 && sec < 85;
    scene9 = sec >= 85 && sec < 120;
...
// scene 7 -- fall thru puddle into trippy tunnel
    if (scene7 == true){
...
// scene 8 -- down rabbit hole into weird place
    if (scene8 == true){
